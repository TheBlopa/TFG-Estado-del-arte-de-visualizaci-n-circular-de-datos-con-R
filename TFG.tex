...
La primera forma de crear los anillos usa la funci\'on \texttt{geom-bar}, la cual reproduce el diagramas de barras cl\'asico, obteniendo su magnitud de la varible que se asigne para indicar su ancho.
\begin{knitrout}
...
\end{kframe}
\end{knitrout}
En esta prueba se establecen 10 anillos designados por letras y el ancho de cada uno es igual.
...
La variable divisi\'on establece que cada anillo solo tendr\'a un vector con 1000 datos y las otras dos variables se van a usar en los diferentes diagramas de cada anillo.~\\
...
Primero se crea la tabla con el nombre de las barras y su valor y se carga la libreria para despu\'es usar sus funciones:
...
Primero se necesita una gran cantidad de datos, aleatorios en este caso.
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
Estos datos son el movimiento de una persona durante 5 d\'ias, indicando la hora cuando se recogieron dichos datos.
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
