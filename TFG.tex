...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{pie}\hlstd{(Porcentaje,} \hlkwc{labels} \hlstd{=} \hlkwd{c}\hlstd{(}\hlstr{"1"}\hlstd{,}\hlstr{"2"}\hlstd{,}\hlstr{"3"}\hlstd{,}\hlstr{"4"}\hlstd{,}\hlstr{"6"}\hlstd{,}\hlstr{"8"}\hlstd{),} \hlkwc{border} \hlstd{=} \hlstr{"white"}\hlstd{,} \hlkwc{col} \hlstd{= miPaleta)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hlstd{data} \hlkwb{<-} \hlstd{data} \hlopt{%>%}
  ...
  \hlkwd{mutate}\hlstd{(}\hlkwc{Porcentaje} \hlstd{= Freq} \hlopt{/} \hlkwd{sum}\hlstd{(Freq)} \hlopt{*}\hlnum{100}\hlstd{)} \hlopt{%>%}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{pie.labels}\hlstd{(}\hlnum{3.25}\hlstd{,} \hlnum{3}\hlstd{, angulos, data}\hlopt{$}\hlstd{Var1,} \hlkwc{minangle} \hlstd{=} \hlnum{0.2}\hlstd{,} \hlkwc{radius} \hlstd{=} \hlnum{1.6}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{pie3D}\hlstd{(data}\hlopt{$}\hlstd{Freq,} \hlkwc{labels} \hlstd{= data}\hlopt{$}\hlstd{Var1,} \hlkwc{explode} \hlstd{=} \hlnum{0.1}\hlstd{,} \hlkwc{main} \hlstd{=} \hlstr{"Coches por Carburadores 3D"}\hlstd{,}
      \hlkwc{col}\hlstd{=}\hlkwd{c}\hlstd{(}\hlstr{"#ff0000"}\hlstd{,}\hlstr{"#80ff00"}\hlstd{,}\hlstr{"#00ffff"}\hlstd{,}\hlstr{"#44bbff"}\hlstd{,}\hlstr{"#8000ff"}\hlstd{))}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{data}\hlkwb{=}\hlkwd{read.csv}\hlstd{(}\hlstr{"rosa.csv"}\hlstd{,} \hlkwc{sep} \hlstd{=} \hlstr{";"}\hlstd{)}
\hlkwd{head}\hlstd{(data)}
\end{alltt}
\begin{verbatim}
##     ï..MES Suici..Ciudad Suici..Rural Acc..Ciudad Acc..Rural
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{legend}(\hlstr{"topright"}, inset=.02, title=\hlstr{"CCAA"},
\hlkwd{circos.clear}()
\hlkwd{circos.yaxis}(labels.cex = 0.4)
                           labels = dataMD$FECHA)\})
               \hlkwd{circos.axis}(h=\hlstr{"top"},direction = \hlstr{"inside"}, labels.facing= \hlstr{"clockwise"}, labels.cex = 0.5, 
